...
<part name="IC2" library="linear" deviceset="78*" device="DT" technology="05" value="NJM2845DL1-33"/>
...
<part name="C1" library="resistor" library_urn="urn:adsk.eagle:library:348" deviceset="CPOL-EU" device="153CLV-0605" package3d_urn="urn:adsk.eagle:package:25889/1" value="47μF 16V"/>
...
<text x="40.64" y="142.24" size="1.778" layer="91">電圧測定プローブをI2Cの4Ch ADC、ADS1015に変更-V.1.6
ADS1015を含めて、I2Cバスの先に装着する</text>
...
<instance part="LED1" gate="G$1" x="-27.94" y="-2.54" smashed="yes" rot="R90">
<attribute name="NAME" x="-23.368" y="1.016" size="1.778" layer="95" rot="R180"/>
</instance>
<instance part="RESET" gate="1" x="-22.86" y="10.16"/>
...
<instance part="SV3" gate="G$1" x="-10.16" y="2.54" rot="MR0"/>
